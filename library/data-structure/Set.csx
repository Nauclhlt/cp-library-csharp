...
public sealed class Set<T> where T : IComparable<T>
{
    ...
    /// <summary>
    /// Adds the specified value. Time complexity is average O(logn).
    /// </summary>
    ...
    /// <summary>
    /// Returns the maximum value contained in the set. Time complexity is average O(logn).
    /// </summary>
    public T Max
    {
        get
    ...
    /// <summary>
    /// Returns the minimum value contained in the set. Time complexity is average O(logn).
    /// </summary>
    public T Min
    {
        get
    ...
    /// <summary>
    /// Determines if the value is contained in the set. Time complexity is average O(logn).
    /// </summary>
    ...
    /// <summary>
    /// Returns the index-th element. Time complexity is average O(logn).
    /// </summary>
    ...
    /// <summary>
    /// If the specified value is contained in the set, returns the index, otherwise, returns -1. Time complexity is average O(logn).
    /// </summary>
    ...
    /// <summary>
    /// Returns the minimum value x contained in the set such that x >= value. If such x is not found in the set, returns fallback. Time complexity is average O(logn).
    /// </summary>
    ...
    /// <summary>
    /// Returns i such that x-th element is greater than or equals to value for all x >= i. Time complexity is average O(logn).
    /// </summary>
    ...
    /// <summary>
    /// Gets the list of all elements contained in the set in ascending order. Time complexity is O(n).
    /// </summary>
    ...
    /// <summary>
    /// Gets the list of all elements contained in the set in descending order. Time complexity is O(n).
    /// </summary>
